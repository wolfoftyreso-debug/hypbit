    ...
    <div className="space-y-4 flex flex-col h-full">
      ...
      <div className="flex gap-2 flex-wrap flex-shrink-0 overflow-x-auto pb-1">
        ...
        <input
          ...
          className="text-xs bg-white border border-gray-200 rounded-lg px-3 py-1.5 text-gray-900 font-mono focus:outline-none w-36"
        />
        <input
          type="date"
          value={dateTo}
        ...
        <input
          ...
          className="text-xs bg-white border border-gray-200 rounded-lg px-3 py-1.5 text-gray-900 placeholder-gray-700 font-mono focus:outline-none w-36"
        />
      </div>
