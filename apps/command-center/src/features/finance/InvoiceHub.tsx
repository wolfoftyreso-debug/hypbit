  ...
  return (
    <div className="bg-white rounded-xl p-6 text-gray-900 min-w-[400px] shadow-2xl">
      ...
      <table className="w-full text-sm mb-4">
        <thead>
          <tr className="border-b border-gray-200 text-xs text-gray-9000 uppercase">
  ...
  return (
    <div className="space-y-4">
        ...
        {(['all', 'draft', 'sent', 'paid', 'overdue'] as const).map(s => {
          ...
          return (
            <button
              ...
              className={`px-3 py-1.5 rounded-lg text-xs font-semibold transition-colors flex items-center gap-1.5 ${statusFilter === s ? 'bg-gray-100 text-gray-900' : 'text-gray-9000 hover:text-gray-9000'}`}
            >
        ...
        <div className="rounded-xl border border-gray-200 bg-white p-4 space-y-3">
          ...
          <div className="flex gap-2 justify-end">
            <button onClick={() => setShowNewForm(false)}
              className="px-4 py-2 rounded-lg border border-gray-200 text-gray-9000 text-xs hover:text-gray-900 transition-colors">
              Avbryt
            </button>
      ...
      <div className="rounded-xl border border-gray-200 bg-white overflow-hidden">
        ...
        <div className="grid grid-cols-12 px-4 py-2 text-[9px] font-mono text-gray-9000 uppercase tracking-wider border-b border-gray-200 min-w-[560px]">
            ...
            <div key={inv.id}
              ...
              <div className="col-span-1 flex justify-end">
                <button
                  ...
                  className="text-xs text-gray-9000 hover:text-gray-900 transition-colors px-2 py-1 rounded bg-gray-50 hover:bg-white/[0.08]"
                >
                  Preview
                </button>
              </div>
