...
export const ENTITIES: Entity[] = [
  // Layer 0 — Root holding
  {
    ...
    description: 'Global holding entity. Owns all IP, trademarks, and code. Receives royalty 5–15% from all subsidiaries.',
    active_status: 'forming',
    color: '#8B5CF6',
    flag: '🇦🇪',
    layer: 0,
    metadata: {
      'IP owner': 'Hypbit, Quixom, LandveX',
      'Revenue model': 'IP royalty 5–15%',
      'Legal form': 'Dubai Free Zone LLC',
  ...
  },
  {
    ...
    jurisdiction: 'SE',
    parent_entity_id: 'wavult-group',
    description: 'Swedish entity for LandveX. Converted from Sommarliden Holding. EU procurement compatible. Targeting Swedish infrastructure authorities.',
    active_status: 'live',
    color: '#EC4899',
    flag: '🇸🇪',
    layer: 2,
    metadata: {
      'Products': 'LandveX (EU/SE), Optical Insight Cloud EU',
      'Legal form': 'AB (Aktiebolag)',
      'Market': 'Sweden → Netherlands → EU',
      'Launch': 'June 2026 — Swedish archipelago',
    },
  },
  // Layer 3 — Systems
  {
