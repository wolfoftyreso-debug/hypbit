...
export const ENTITIES: Entity[] = [
  ...
  },
  {
    ...
    jurisdiction: 'SE',
    parent_entity_id: 'wavult-group',
    description: 'Operativt SE-bolag (Sommarliden Holding AB, org. 559141-7042). Planerad namnändring till LandveX AB. Hanterar EU/SE-försäljning av LandveX-plattformen. Äger INTE IP — licensierar från Dubai-holdingen.',
    active_status: 'forming',
    color: '#EC4899',
    flag: '🇸🇪',
    layer: 2,
    metadata: {
      'Legal name': 'Sommarliden Holding AB',
