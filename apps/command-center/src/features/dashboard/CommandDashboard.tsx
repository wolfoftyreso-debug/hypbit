...
const TEAM_ACTIVITY = [
  { name: 'Winston Adeyemi', role: 'Backend', task: 'Bygger ECS deployment pipeline', status: 'active', since: '09:15', color: '#3B82F6' },
  { name: 'Johan Lundqvist', role: 'Frontend', task: 'Pixdrift admin-panel CRM views', status: 'active', since: '10:30', color: '#8B5CF6' },
  { name: 'Leon Ritzén', role: 'Sales', task: 'Demo-möte Kommun X kl 14:00', status: 'meeting', since: '14:00', color: '#34C759' },
  { name: 'Dennis Lindqvist', role: 'Bolagsdrift', task: 'Texas LLC incorporation docs', status: 'idle', since: '08:45', color: '#FF9500' },
  { name: 'Erik Svensson', role: 'CEO', task: 'Thailand workcamp planning', status: 'active', since: '11:00', color: '#AF52DE' },
]
