      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        {[
          isRoot
            ...
            : { label: 'Bolag', value: '1', delta: activeEntity.name, color: '#3B82F6',
          ...
          isRoot
            ...
            : { label: 'Allokeringar', value: String(cfoData.infraCosts.length), delta: activeEntity.name, color: '#FF9500',
          ...
          isRoot
            ...
            : { label: 'Jurisdiktion', value: activeEntity.jurisdiction ?? 'Okänd', delta: activeEntity.name, color: '#2563EB',
