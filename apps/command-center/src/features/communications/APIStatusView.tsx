...
const INITIAL_SERVICES: APIService[] = [
  ...
  },
  {
    ...
    latency_ms: 38,
    configured: true,
    endpoint: 'db.wavult.com:5432',
    description: 'Self-hosted PostgreSQL — eu-north-1, auth & realtime',
  },
  {
    id: 'aws-ecs',
    name: 'AWS ECS',
    ...
    description: 'Container orchestration — wavult / wavult-os-api cluster',
  },
  {
    id: 'gitea-ci',
    name: 'Wavult CI/CD (Gitea)',
    icon: '🔧',
    status: 'ok',
    lastPing: '2026-03-26T09:05:00Z',
    latency_ms: 201,
    configured: true,
    endpoint: 'git.wavult.com',
    description: 'CI/CD pipelines — wavult/wavult-os (self-hosted Gitea + DevSecOps)',
  },
  {
    id: 'cloudflare',
    name: 'Cloudflare',
          ...
          return (
            <div
              ...
              className={`bg-white rounded-xl border p-4 ${
                svc.status !== 'ok' ? sc.bg : 'border-gray-200'
              }`}
            >
