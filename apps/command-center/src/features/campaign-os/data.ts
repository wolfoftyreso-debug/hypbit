...
export const CAMPAIGN_ACTIVITIES: CampaignActivity[] = [
  ...
  // 12a. QuiXzoom EU — LinkedIn Sverige (extra)
  {
    id: 'cos-012a',
    name: 'QuiXzoom EU LinkedIn Sverige Q2',
    brand: 'quixzoom',
    country: 'Sweden',
    entity_id: 'quixzoom-uab',
    site_id: 'site-se',
    ...
    asset: {
      id: 'ast-012a',
      type: 'copy',
      name: 'QZ EU LinkedIn SE copy Q2',
      ready: false,
    },
    budget: {
      id: 'bud-012a',
    ...
    kpi: { metric: 'leads', target: 60, current: 0, result: 'pending' },
    responsible_role_id: 'ceo-ops',
    description: 'QuiXzoom EU LinkedIn-kampanj riktad mot svenska fastighetsmäklare och SME-ägare i maj. Målet: öka varumärkeskännedom och generera demos inför sommarlanseringen.',
    alerts: [],
  },

  // 12b. QuiXzoom EU — Meta Thailand (extra)
  {
    id: 'cos-012b',
    name: 'QuiXzoom EU Meta Thailand Boost',
    brand: 'quixzoom',
    country: 'Thailand',
    entity_id: 'quixzoom-uab',
    site_id: 'site-th',
    ...
    asset: {
      id: 'ast-012b',
      type: 'image',
      name: 'QZ Thailand Meta creatives v2',
      ready: false,
    },
    budget: {
      id: 'bud-012b',
    ...
    kpi: { metric: 'impressions', target: 50000, current: 0, result: 'pending' },
    responsible_role_id: 'ceo-ops',
    description: 'Meta Ads-boost i Thailand för att nå turister och expats. Körs parallellt med workcampen i april/maj.',
    alerts: [],
  },

  // 12c. QuiXzoom US — LinkedIn USA
  {
    id: 'cos-012c',
    name: 'QuiXzoom US LinkedIn USA Launch',
    brand: 'quixzoom',
    country: 'USA',
    entity_id: 'landvex-inc',
    site_id: 'site-us-tx',
    ...
    automation: {
      ...
      channel_api: 'linkedin',
      retry_count: 2,
      next_run: '2026-05-20T14:00:00Z',
    },
    kpi: { metric: 'leads', target: 40, current: 0, result: 'pending' },
    responsible_role_id: 'clo',
    description: 'QuiXzoom US LinkedIn-kampanj riktad mot amerikanska real estate-bolag och fotografer i Texas. Syftar till att etablera varumärket inför USA-lansering via Landvex Inc-entiteten.',
    alerts: [],
  },

  // 12d. Landvex SE — Outbound till kommuner
  {
    id: 'cos-012d',
    name: 'Landvex SE Outbound Kommuner',
    brand: 'landvex',
    country: 'Sweden',
    entity_id: 'quixzoom-uab',
    site_id: 'site-se',
    ...
    asset: {
      id: 'ast-012d',
      type: 'copy',
      name: 'Landvex SE kommunsekvens (3-step)',
      ready: false,
    },
    budget: {
      id: 'bud-012d',
    ...
    automation: {
      ...
      channel_api: 'outbound',
      retry_count: 3,
      next_run: '2026-04-22T08:30:00Z',
    },
    kpi: { metric: 'leads', target: 20, current: 0, result: 'pending' },
    responsible_role_id: 'ceo-ops',
    description: 'Outbound-sekvens riktad mot plan- och byggkontor i svenska kommuner. Erbjuder Landvex fastighetsdata som stöd vid bygglovshantering och detaljplanearbete.',
    alerts: [],
  },

  // 12e. Landvex SE — Email
  {
    id: 'cos-012e',
    name: 'Landvex SE Email Nyhetsbrev Maj',
    brand: 'landvex',
    country: 'Sweden',
    entity_id: 'quixzoom-uab',
    site_id: 'site-se',
    ...
    asset: {
      id: 'ast-012e',
      type: 'email-template',
      name: 'Landvex SE nyhetsbrev maj 2026',
      ready: false,
    },
    budget: {
      id: 'bud-012e',
    ...
    automation: {
      ...
      channel_api: 'email',
      retry_count: 1,
      next_run: '2026-05-03T10:00:00Z',
    },
    kpi: { metric: 'ctr', target: 20, current: 0, result: 'pending' },
    responsible_role_id: 'ceo-ops',
    description: 'Månadsnyhetsbrev till Landvex befintliga kontakter — mäklare, fastighetsbolag och kommunala tjänstemän. Innehåll: fastighetsdatatrender, produktnyheter och case studies.',
    alerts: [],
  },

  // 12f. Landvex US — LinkedIn USA
  {
    id: 'cos-012f',
    name: 'Landvex US LinkedIn USA',
    brand: 'landvex',
    country: 'USA',
    entity_id: 'landvex-inc',
    site_id: 'site-us-tx',
    ...
    asset: {
      id: 'ast-012f',
      type: 'copy',
      name: 'Landvex US LinkedIn copy v1',
      ready: false,
    },
    budget: {
      id: 'bud-012f',
    ...
    automation: {
      ...
      channel_api: 'linkedin',
      retry_count: 2,
      next_run: '2026-06-08T15:00:00Z',
    },
    kpi: { metric: 'leads', target: 30, current: 0, result: 'pending' },
    responsible_role_id: 'clo',
    description: 'Landvex US LinkedIn-kampanj riktad mot real estate investment firms och property data buyers i USA. Etablerar varumärket som pålitlig fastighetsdata-partner.',
    alerts: [],
  },
  ...
  {
    id: 'cos-012g',
    name: 'Wavult Group PR Pressrelease',
    brand: 'wavult',
    country: 'Sweden',
    entity_id: 'wavult-group',
    site_id: 'site-se',
    ...
    asset: {
      id: 'ast-012g',
      type: 'copy',
      name: 'Wavult Group pressrelease Q2 2026',
      ready: false,
    },
    budget: {
      id: 'bud-012g',
    ...
    kpi: { metric: 'impressions', target: 10000, current: 0, result: 'pending' },
    responsible_role_id: 'ceo-ops',
    description: 'Pressrelease om Wavult Groups expansion och bolagsstrukturen inför Thailand-workcampen. Distribueras via Cision till svenska tech- och affärsmedier.',
    alerts: [],
  },

  // 12h. Wavult Group — LinkedIn
  {
    id: 'cos-012h',
    name: 'Wavult Group LinkedIn Employer Brand',
    brand: 'wavult',
    ...
    asset: {
      id: 'ast-012h',
      type: 'copy',
      name: 'Wavult Group employer brand posts maj',
      ready: false,
    },
    budget: {
      id: 'bud-012h',
    ...
    kpi: { metric: 'impressions', target: 5000, current: 0, result: 'pending' },
    responsible_role_id: 'ceo-ops',
    description: 'Wavult Group employer brand LinkedIn-posts för att attrahera senior talang (CRO, Head of Engineering). Publiceras MWF under maj.',
    alerts: [],
  },

  // 12i. Litauen/UAB — Tech Meetup
  {
    id: 'cos-012i',
    name: 'QuiXzoom UAB Tech Meetup Vilnius',
    brand: 'quixzoom',
    country: 'Lithuania',
    entity_id: 'quixzoom-uab',
    site_id: 'site-lt',
    ...
    asset: {
      id: 'ast-012i',
      type: 'copy',
      name: 'Vilnius Tech Meetup agenda & slides',
      ready: false,
    },
    budget: {
      id: 'bud-012i',
    ...
    kpi: { metric: 'leads', target: 25, current: 0, result: 'pending' },
    responsible_role_id: 'ceo-ops',
    description: 'Tech Meetup i Vilnius för att presentera QuiXzoom UAB-plattformen och rekrytera lokala fototalanger och tech-partners. Samarrangerat med lokalt startup-community.',
    alerts: [],
  },
