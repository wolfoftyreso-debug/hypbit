...
export const mockMeetings: Meeting[] = [
  {
    ...
    participants: ['erik@wavult.com', 'winston@wavult.com', 'leon@wavult.com', 'dennis@wavult.com', 'johan@wavult.com'],
    agenda: [budgetBlock, expansionBlock],
    status: 'scheduled',
    minutesGenerated: false,
    createdBy: 'erik@wavult.com',
    entity: 'wavult-group',
    required_docs: ['Årsplan', 'Budget', 'OKR-dokument', 'Styrelsebeslut'],
  },
  {
    id: 'meeting-board-2026',
    level: 'annual',
    title: 'Board Meeting — Wavult Group',
    scheduledAt: '2026-04-10T09:00:00Z',
    participants: ['erik@wavult.com', 'dennis@wavult.com', 'winston@wavult.com'],
    agenda: [],
    status: 'scheduled',
    minutesGenerated: false,
    createdBy: 'erik@wavult.com',
    entity: 'wavult-group',
    required_docs: ['Protokoll', 'Beslutslog', 'Signaturlista'],
  },
  {
    ...
    participants: ['erik@wavult.com', 'winston@wavult.com', 'leon@wavult.com'],
    agenda: [],
    status: 'blocked',
    ...
    createdBy: 'erik@wavult.com',
    entity: 'wavult-group',
    required_docs: ['OKR-rapport', 'Financial Summary', 'Action Items'],
  },
  {
    id: 'meeting-qbr-quixzoom-eu',
    level: 'qbr',
    title: 'QBR — QuiXzoom UAB (EU)',
    scheduledAt: '2026-05-01T12:00:00Z',
    participants: ['leon@wavult.com', 'johan@wavult.com'],
    agenda: [],
    status: 'scheduled',
    minutesGenerated: false,
    createdBy: 'leon@wavult.com',
    entity: 'quixzoom-uab',
    required_docs: ['OKR-rapport', 'Financial Summary', 'Action Items'],
  },
  {
    id: 'meeting-management-review-landvex',
    level: 'management-review',
    title: 'Management Review — Landvex AB',
    ...
    createdBy: 'erik@wavult.com',
    entity: 'landvex-ab',
    required_docs: ['Protokoll', 'KPI-rapport', 'Kundnöjdhetsdata'],
  },
  {
    id: 'meeting-risk-assessment-wavult',
    level: 'risk-assessment',
    title: 'Risk Assessment — Wavult Group',
    scheduledAt: '2026-04-20T09:00:00Z',
    participants: ['erik@wavult.com', 'dennis@wavult.com', 'leon@wavult.com'],
    agenda: [],
    status: 'scheduled',
    minutesGenerated: false,
    createdBy: 'erik@wavult.com',
    entity: 'wavult-group',
    required_docs: ['Riskmatris', 'Mitigationsplan'],
  },
  {
    id: 'meeting-capa-review-landvex',
    level: 'capa-review',
    title: 'CAPA Review — Landvex AB',
    scheduledAt: '2026-05-10T10:00:00Z',
    participants: ['dennis@wavult.com', 'leon@wavult.com'],
    agenda: [],
    status: 'scheduled',
    minutesGenerated: false,
    createdBy: 'dennis@wavult.com',
    entity: 'landvex-ab',
    required_docs: ['CAPA-rapport', 'Rotorsaksanalys', 'Åtgärdsplan'],
  },
  {
    id: 'meeting-internal-audit-quixzoom',
    level: 'internal-audit',
    title: 'Internal Audit — QuiXzoom UAB',
    scheduledAt: '2026-05-20T09:00:00Z',
    participants: ['dennis@wavult.com', 'winston@wavult.com'],
    agenda: [],
    status: 'scheduled',
    minutesGenerated: false,
    createdBy: 'dennis@wavult.com',
    entity: 'quixzoom-uab',
    required_docs: ['Revisionsplan', 'Avvikelserapport', 'Åtgärdsplan'],
  },
  {
    id: 'meeting-kpi-review-landvex-us',
    level: 'kpi-review',
    title: 'KPI Review — Landvex Inc (US)',
    scheduledAt: '2026-05-28T15:00:00Z',
    participants: ['erik@wavult.com', 'winston@wavult.com'],
    agenda: [],
    status: 'scheduled',
    minutesGenerated: false,
    createdBy: 'erik@wavult.com',
    entity: 'landvex-inc',
    required_docs: ['KPI-rapport', 'Dashboard-export'],
  },
  {
    id: 'meeting-compliance-wavult',
    level: 'compliance-review',
    title: 'Compliance Review — Wavult Group',
    scheduledAt: '2026-06-10T09:00:00Z',
    participants: ['dennis@wavult.com', 'erik@wavult.com'],
    agenda: [],
    status: 'scheduled',
    minutesGenerated: false,
    createdBy: 'dennis@wavult.com',
