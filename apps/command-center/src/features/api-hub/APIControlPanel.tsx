...
const API_CATALOG = [
  ...
  { id: 'cloudflare-dns', name: 'Cloudflare DNS', category: 'Domains', tier: 'general', status: 'active', cost_estimate: 'Free' },
  { id: 'mapbox', name: 'Mapbox', category: 'Maps', tier: 'general', status: 'active', cost_estimate: 'Free tier' },
  { id: 'postgresql', name: 'PostgreSQL (self-hosted)', category: 'Database', tier: 'general', status: 'active', cost_estimate: 'Self-hosted (eu-north-1)' },
