...
const CORP_ENTITIES = [
  { id: '1', name: 'Wavult Group Holding DMCC', short_name: 'WGH', jurisdiction: 'UAE (DIFC)', status: 'aktiv', layer: 0, color: '#E8B84B', flag: '🇦🇪', active_status: 'live', created_at: '2024-01-01', updated_at: '2024-01-01' },
  { id: '2', name: 'Wavult Operations Holding AB', short_name: 'WOH', jurisdiction: 'Sverige', status: 'aktiv', layer: 1, color: '#0A3D62', flag: '🇸🇪', active_status: 'live', created_at: '2024-01-01', updated_at: '2024-01-01' },
  { id: '3', name: 'Optical Zoom UAB', short_name: 'OZ-LT', jurisdiction: 'Litauen', status: 'aktiv', layer: 2, color: '#2D7A4F', flag: '🇱🇹', active_status: 'live', created_at: '2024-01-01', updated_at: '2024-01-01' },
  { id: '4', name: 'Optical Zoom Inc', short_name: 'OZ-US', jurisdiction: 'Delaware, USA', status: 'aktiv', layer: 2, color: '#2C6EA6', flag: '🇺🇸', active_status: 'live', created_at: '2024-01-01', updated_at: '2024-01-01' },
  { id: '5', name: 'LandveX AC', short_name: 'LVX-AE', jurisdiction: 'UAE (DIFC)', status: 'forming', layer: 2, color: '#C9A84C', flag: '🇦🇪', active_status: 'forming', created_at: '2024-01-01', updated_at: '2024-01-01' },
  { id: '6', name: 'LandveX Inc', short_name: 'LVX-US', jurisdiction: 'Texas, USA', status: 'forming', layer: 2, color: '#4A7A5B', flag: '🇺🇸', active_status: 'forming', created_at: '2024-01-01', updated_at: '2024-01-01' },
]

const CORP_BOARD_MEETINGS: any[] = []
...
export function useCorpBoardMeetings(_filters?: any) {
  return { data: CORP_BOARD_MEETINGS, isLoading: false, error: null, refetch: () => {} }
}
