          ...
          {entities.map(e => (
            <div key={e.id} className="bg-gray-50 border border-white/[0.07] rounded-xl p-4">
              <div className="flex items-center gap-2 mb-2">
                ...
                <span className="text-[9px] text-gray-9000 font-mono ml-auto">{e.country}</span>
              </div>
              <p className="text-lg font-bold" style={{ color: e.color }}>{fmt(e.arr)}</p>
              <div className="mt-2 space-y-1">
                <div className="flex justify-between text-xs text-gray-9000">
                  <span>Cash</span>
              ...
              return (
                <div key={item.id} className="bg-gray-50 border border-white/[0.07] rounded-xl p-3 flex gap-3">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-xs text-gray-9000 mt-0.5">{item.description}</p>
          ...
          <div>
            ...
            <div className="bg-gradient-to-br from-[#6C63FF]/10 to-[#00C2FF]/10 border border-[#6C63FF]/20 rounded-xl p-5 text-center">
              ...
              <div className="mt-3 space-y-1 text-left">
                <div className="text-xs text-gray-9000">Vecka 1: Teambuilding + utbildning</div>
                <div className="text-xs text-gray-9000">Vecka 2+: Projektuppsättning</div>
              </div>
            </div>
          </div>
              ...
              {NEXT_MILESTONES.slice(0, 5).map((m, i) => {
                ...
                return (
                  ...
                  >
                    ...
                    <span className="font-mono text-[9px] text-gray-9000">{isPast ? '✓' : `${days}d`}</span>
                  </div>
                )
              })}
            </div>
