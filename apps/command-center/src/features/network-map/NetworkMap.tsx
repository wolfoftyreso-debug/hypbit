...
const ALL_NODES: NetNode[] = [
  ...
  { id: 'hb-api',         hostname: 'api.hypbit.com',        label: 'hypbit API (legacy)', kind: 'api',     zone: 'hypbit.com',    target: 'hypbit-api-alb → ECS',                provider: 'AWS ALB',      status: 'unknown', description: 'Legacy API alias — samma backend som api.wavult.com', url: 'https://api.hypbit.com/api/health', critical: false },
