...
export const JURISDICTIONS: Jurisdiction[] = [
  {
    ...
    rules: [
      ...
      { id: 'se-8', category: 'dataskydd', title: 'NIS2 — Riskanalys (Art. 21.2a)', description: 'Dokumentera risker mot Wavult DS-systemet. QMS-modulen täcker detta delvis. Behöver formaliseras och signeras.', authority: 'MSB (Sverige)', status: 'pågår', priority: 'hög' },
      { id: 'se-9', category: 'dataskydd', title: 'NIS2 — Incidenthantering (Art. 21.2b)', description: 'Skriftliga rutiner för cybersäkerhetsincidenter. 24h rapporteringsplikt till MSB vid allvarlig incident. Rutin saknas — Johan ansvarig.', authority: 'MSB', status: 'gap', priority: 'hög' },
