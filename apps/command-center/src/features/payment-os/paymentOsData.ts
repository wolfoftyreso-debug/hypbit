...
export const COMPLIANCE_MAP: ComplianceRequirement[] = [
  ...
  { id: 'cr-7', jurisdiction: 'Global', regulation: 'PCI DSS', applies_to: ['wavult-operations'], status: 'planned', notes: 'Required when self-hosting Hyperswitch vault. SAQ-D or Level 1 depending on volume.', deadline: '2026-Q4' },
